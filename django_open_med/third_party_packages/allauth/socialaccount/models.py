...
import third_party_packages.allauth.app_settings
from third_party_packages.allauth.account.models import EmailAddress
from third_party_packages.allauth.account.utils import get_next_redirect_url, setup_user_email
from third_party_packages.allauth.utils import (get_user_model, serialize_instance,
...
class SocialAccount(models.Model):
    user = models.ForeignKey(third_party_packages.allauth.app_settings.USER_MODEL)
    provider = models.CharField(max_length=30,
                                choices=providers.registry.as_choices())

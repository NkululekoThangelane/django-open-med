...
from third_party_packages.form_designer.fields import TemplateTextField, TemplateCharField, ModelNameField, RegexpExpressionField
from third_party_packages.form_designer.utils import get_class
from third_party_packages.form_designer import settings
...
class FormDefinition(models.Model):
    ...
    def get_absolute_url(self):
        if self.require_hash:
            return ('third_party_packages.form_designer.views.detail_by_hash', [str(self.public_hash)])
        return ('third_party_packages.form_designer.views.detail', [str(self.name)])
...
if 'south' in django_settings.INSTALLED_APPS:
    ...
    add_introspection_rules([], ["^third_party_packages.form_designer\.fields\..*"])

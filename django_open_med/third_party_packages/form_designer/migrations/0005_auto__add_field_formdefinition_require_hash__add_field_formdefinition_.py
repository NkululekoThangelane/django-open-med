...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('form_designer_formdefinitionfield', 'regex', self.gf('third_party_packages.form_designer.fields.RegexpExpressionField')(max_length=255, null=True, blank=True))
    ...
    models = {
        ...
        'form_designer.formdefinitionfield': {
            ...
            'regex': ('third_party_packages.form_designer.fields.RegexpExpressionField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('form_designer_formdefinition', (
            ...
            ('mail_to', self.gf('third_party_packages.form_designer.fields.TemplateCharField')(max_length=255, null=True, blank=True)),
            ('mail_from', self.gf('third_party_packages.form_designer.fields.TemplateCharField')(max_length=255, null=True, blank=True)),
            ('mail_subject', self.gf('third_party_packages.form_designer.fields.TemplateCharField')(max_length=255, null=True, blank=True)),
            ...
            ('message_template', self.gf('third_party_packages.form_designer.fields.TemplateTextField')(null=True, blank=True)),
        ...
        db.create_table('form_designer_formdefinitionfield', (
            ...
            ('choice_model', self.gf('third_party_packages.form_designer.fields.ModelNameField')(max_length=255, null=True, blank=True)),
    ...
    models = {
        'form_designer.formdefinition': {
            ...
            'mail_from': ('third_party_packages.form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'mail_subject': ('third_party_packages.form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'mail_to': ('third_party_packages.form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'message_template': ('third_party_packages.form_designer.fields.TemplateTextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'form_designer.formdefinitionfield': {
            ...
            'choice_model': ('third_party_packages.form_designer.fields.ModelNameField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),

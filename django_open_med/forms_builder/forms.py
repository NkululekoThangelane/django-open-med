...
from forms_builder.models import FormEntry, FieldEntry
from forms_builder import settings
from forms_builder.utils import now, split_choices
...
class FormForForm(forms.ModelForm):
    ...
    class Meta:
        model = FormEntry
        exclude = ("form", "entry_time", "entry_user")

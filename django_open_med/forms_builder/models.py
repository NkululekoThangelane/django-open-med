...
from forms_builder import fields
from forms_builder import settings
from forms_builder.utils import now, slugify, unique_slug
...
class AbstractForm(models.Model):
    ...
    created_by_user = models.ForeignKey(django_settings.AUTH_USER_MODEL)
...
class AbstractFormEntry(models.Model):
    ...
    entry_user = models.ForeignKey(django_settings.AUTH_USER_MODEL, null=True)

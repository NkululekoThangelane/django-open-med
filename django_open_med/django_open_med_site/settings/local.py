...
THIRD_PARTY_APPS = (
    ...
    'randomslugfield',
    'notification',
    'third_party_packages.organizations',
    'third_party_packages.schedule',
    'third_party_packages.crm',
    'third_party_packages.form_designer',
    'floppyforms',
    'third_party_packages.allauth',
    'third_party_packages.allauth.account',
    'third_party_packages.allauth.socialaccount',
    'third_party_packages.allauth.socialaccount.providers.facebook',
    'third_party_packages.allauth.socialaccount.providers.google',
    'third_party_packages.allauth.socialaccount.providers.twitter',
    'rest_framework',
    'autoslug',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Form'
        db.create_table('forms_builder_form', (
        ...
        db.send_create_signal('forms_builder', ['Form'])

        # Adding M2M table for field sites on 'Form'
        db.create_table('forms_builder_form_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('form', models.ForeignKey(orm['forms_builder.form'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('forms_builder_form_sites', ['form_id', 'site_id'])

        # Adding model 'Field'
        db.create_table('forms_builder_field', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields', to=orm['forms_builder.Form'])),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('forms_builder', ['Field'])

        # Adding model 'FormEntry'
        db.create_table('forms_builder_formentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['forms_builder.Form'])),
        ))
        db.send_create_signal('forms_builder', ['FormEntry'])

        # Adding model 'FieldEntry'
        db.create_table('forms_builder_fieldentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_id', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields', to=orm['forms_builder.FormEntry'])),
        ))
        db.send_create_signal('forms_builder', ['FieldEntry'])


    def backwards(self, orm):
        
        # Deleting model 'Form'
        db.delete_table('forms_builder_form')

        # Removing M2M table for field sites on 'Form'
        db.delete_table('forms_builder_form_sites')

        # Deleting model 'Field'
        db.delete_table('forms_builder_field')

        # Deleting model 'FormEntry'
        db.delete_table('forms_builder_formentry')

        # Deleting model 'FieldEntry'
        db.delete_table('forms_builder_fieldentry')
    ...
    models = {
        'forms_builder.field': {
            ...
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fields'", 'to': "orm['forms_builder.Form']"}),
        ...
        'forms_builder.fieldentry': {
            'Meta': {'object_name': 'FieldEntry'},
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fields'", 'to': "orm['forms_builder.FormEntry']"}),
        ...
        'forms_builder.formentry': {
            'Meta': {'object_name': 'FormEntry'},
            'entry_time': ('django.db.models.fields.DateTimeField', [], {}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['forms_builder.Form']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
